...
//temporary random color for customers
customerColor = [spr_customerStanding, spr_customerStandingR, spr_customerStandingG, spr_customerStandingB];
colorIndex = irandom(array_length_1d(customerColor) - 1);
sprite_index = customerColor[colorIndex];