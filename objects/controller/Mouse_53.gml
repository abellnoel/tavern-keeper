...
if (customerSelect == noone) { 
	...
	if (tableAtMouse != noone and tableAtMouse.chairsAvailable > 0 and customerSelect.seatable) { //only if chairs are available, also only if customer is seatable at time of seating
