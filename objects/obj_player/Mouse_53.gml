...
if (customerSelect == noone) { 
	...
	//only activiates if there is a customer at mouse and customerSelect is not noone
	//REASONING:
	...
	if (customerAtMouse != customerSelect and customerAtMouse != noone and customerSelect != noone) { 
		customerSelect = customerAtMouse;
	}
